...
public struct SavedRulesSheetView: View {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("These limits are automatically applied whenever ThrottleNet detects the process running.")
                .font(.system(size: 11))
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                ...
                                HStack(spacing: 6) {
                                    ...
                                    if let lastApplied = rule.lastAppliedAt {
                                        Text("• Last applied \(lastApplied.formatted(date: .omitted, time: .shortened))")
                                            .font(.system(size: 10))
                                            .foregroundColor(.secondary)
                                    }
                                }
