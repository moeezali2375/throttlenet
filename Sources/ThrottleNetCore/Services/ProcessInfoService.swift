...
public final class ProcessInfoService {
  ...
  public func resolveInfo(for pid: pid_t, rawName: String) -> (
    displayName: String, bundleId: String?, icon: NSImage?, isSystem: Bool
  ) {
  ...
  private func defaultIcon(for name: String) -> NSImage {
    ...
    if lower.contains("cloud") || lower.contains("bird") {
      return NSImage(systemSymbolName: "icloud.fill", accessibilityDescription: "Cloud")
        ?? defaultGenericIcon()
      ...
      || lower.contains("browser")
    {
      ...
      return NSImage(systemSymbolName: "music.note", accessibilityDescription: "Music")
        ?? defaultGenericIcon()
    } else if lower.contains("chat") || lower.contains("whatsapp") || lower.contains("telegram")
      || lower.contains("slack")
    {
      return NSImage(systemSymbolName: "message.fill", accessibilityDescription: "Chat")
        ?? defaultGenericIcon()
    } else if lower.contains("node") || lower.contains("python") || lower.contains("antigravity")
      || lower.contains("code")
    {
      return NSImage(
        systemSymbolName: "chevron.left.forwardslash.chevron.right",
        accessibilityDescription: "Code") ?? defaultGenericIcon()
    } else {
